...
### other stations ----------------
Hydrogen_stations <- Alt_stations %>% select(ï..Fuel.Type.Code, City, Latitude, Longitude, State, Hydrogen.Status.Link, Hydrogen.Is.Retail, Hydrogen.Pressures, Hydrogen.Standards)

CNG_stations <- Alt_stations%>% select(ï..Fuel.Type.Code, City, Latitude, Longitude, State, CNG.Fill.Type.Code, CNG.Storage.Capacity, CNG.Total.Compression.Capacity, CNG.Vehicle.Class, CNG.On.Site.Renewable.Source, CNG.Dispenser.Num, CNG.PSI)
