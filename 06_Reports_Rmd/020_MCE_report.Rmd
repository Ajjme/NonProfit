...
# **Advantages of Opting for Marin County Energy(MCE)**
...
MCE_score
```
80 Percent of Contra Costa County Cities are actively enrolled in MCE. Scores here give 50 points for being enrolled, 25 points for having the city municipality enrolled in Deep Green. (MCE's 100 percent renewable energy option). The last 25 points are awarded based on local participation rates with the leading city getting all 25 points and each city getting a portion of the 25 points based how they compare to the leading city. 
